...
bool WaveformRendererFiltered::preprocessInner() {
    ...
    // Stacked waveforms are layered band envelopes. Connect adjacent display
    // samples so decays taper continuously instead of becoming a sequence of
    // independently clipped rectangles. Other filtered waveform types retain
    // their established rectangle geometry.
